...
SSplotComparisons(SSsummarize(list(rock.sim1,rock5,rock6)),subplot=1:12)
...
SSplotBiology(rock5,subplot=2)
SSplotBiology(rock6,subplot=2)

# get profile over
#setwd('c:/GitHub/SSgrowth/growth/')
SS_profile(dir="c:/GitHub/SSgrowth/growth/rockfish_estimation_5_profile",
           masterctlfile="control_MLE.ss",
           string="CV_young_Fem_GP_1",
           profilevec=seq(0.04,0.24,0.02),
